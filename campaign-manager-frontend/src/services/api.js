...
var ABTestService = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("https://abtest.winfuture.mobi/backend/create_campaign", {
                                method: 'POST',
                                headers: {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fetch("https://abtest.winfuture.mobi/backend/pause/".concat(campaignId), {
                                method: 'PUT'
                            })];
                    case 1:
                        response = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fetch("https://abtest.winfuture.mobi/backend/resume/".concat(campaignId), {
                                method: 'PUT'
                            })];
                    case 1:
                        response = _a.sent();
    ...
    */
    checkElementExistence: function (identifier, type) {
        return __awaiter(this, void 0, void 0, function () {
            var url, response, data, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = 'https://winfuture:betatest@dev7.winfuture.de:49443';
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, fetch('https://abtest.winfuture.mobi/backend/check_element', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json'
                                },
                    ...
                    case 4:
                        error_5 = _a.sent();
                        console.error('Error checking element existence:', error_5);
                        throw error_5;
