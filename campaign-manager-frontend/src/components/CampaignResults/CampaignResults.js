        ...
        return (React.createElement("div", { style: { marginBottom: '20px' }, key: result.campaign_id },
            ...
            React.createElement(Table, { style: { marginBottom: '20px' } },
                ...
                React.createElement(TableBody, null,
                    React.createElement(TableRow, null,
                        React.createElement(TableCell, null, result.control.name),
                        React.createElement(TableCell, null, result.control.total_views),
                        React.createElement(TableCell, null, result.control.total_clicks),
                        React.createElement(TableCell, null,
                            result.control.ctr.toPrecision(2),
                            "%")))),
            ...
            React.createElement(Table, null,
                React.createElement(TableHead, null,
                    React.createElement(TableRow, null,
                        ...
                        React.createElement(TableCell, null, "Total Clicks"),
                        React.createElement(TableCell, null, "Click Through Rate"))),
                React.createElement(TableBody, null, result.variants.map(function (variant, index) { return (React.createElement(TableRow, { key: index },
                    React.createElement(TableCell, null, variant.name),
                    React.createElement(TableCell, null, variant.total_views),
                    React.createElement(TableCell, null, variant.total_clicks),
                    React.createElement(TableCell, null,
                        variant.ctr.toPrecision(2),
                        "%"))); })))));
    };
