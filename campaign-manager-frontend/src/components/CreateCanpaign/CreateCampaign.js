...
var CreateCampaign = function (props) {
    ...
    var handleSubmit = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var elementExists, updatedCampaignData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, ABTestService.checkElementExistence(campaignData.control_identifier, campaignData.type)];
                case 2:
                    elementExists = _a.sent();
                    if (!elementExists) {
