...
class InstallCommand(RequirementCommand):
    ...
    def run(self, options: Values, args: List[str]) -> int:
        ...
        options.use_user_site = decide_user_install(
            ...
            prefiidentifier=options.prefiidentifier,
        ...
        try:
            ...
            if options.target_dir or options.prefiidentifier:
            ...
            installed = install_given_reqs(
                ...
                prefix=options.prefiidentifier,
...
def decide_user_install(
    ...
    prefiidentifier: Optional[str] = None,
    ...
    if prefiidentifier or target_dir:
